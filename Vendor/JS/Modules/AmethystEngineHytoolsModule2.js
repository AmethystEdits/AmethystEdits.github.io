export default function AEHypixelModule(){
return {
        ...
        versionCheck: function() {
            this.AEPlaceholders.AE4();
            if(this.AEPlaceholders.CallVersion === true){
                let AE9 = this.AEPlaceholders.AE2.Version;
                if(AE9 !== this.Version){
                    console.log("Amethyst Engine // Hypixel Frame work has updated to V" + this.AEPlaceholders.AE2.Version + "."); // %!%!/ dont check this, add the link to my github realeas pagte
                }
                else{
                ...
                let AE9 = this.AEPlaceholders.AE2.Version;
                if(AE9 !== this.Version){
                    this.AEPlaceholders.VersionType = "Amethyst Engine // Hypixel Frame work has updated. Please visit "; // %!%!/ dont check this, add the link to my github realeas pagte
                    this.AEPlaceholders.RealVersion = AE9;
                }
                else{
                    this.AEPlaceholders.VersionType = "Amethyst Engine // Hypixel Frame Work is up to date.";
                    this.AEPlaceholders.RealVersion = AE9;
                };
            };
        },
